...
export class AppComponent {
  ...
  public rigNameList = [
    ...new Set(scheduleData.map((item) => item['RigName'])),
  ];
  public assetList = [...new Set(scheduleData.map((item) => item['Asset']))];
  public funnelList = [
    ...new Set(scheduleData.map((item) => item['FunnelName'])),
  ];
  public projectTypeList = [
    ...new Set(scheduleData.map((item) => item['ProjectType'])),
  ];
  public wellTypeList = [
    ...new Set(scheduleData.map((item) => item['WellType'])),
  ];
  public contractList = [
    ...new Set(scheduleData.map((item) => item['Contract'])),
  ];
  public depthList = [...new Set(scheduleData.map((item) => item['Depth']))];
  ...
  onDatabound(args) {
    let currentDateTd: HTMLElement =
      this.scheduleObj.element.querySelector('.e-current-date');
